...
import arcadework.guns.entity.FtEntity;
...
public class FtRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FtEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelZeusModel(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("guns:textures/entities/glock_main.png");
					}
				};
			});
		}
