...
import arcadework.guns.entity.renderer.GunRenderer;
import arcadework.guns.GunsModElements;

@GunsModElements.ModElement.Tag
public class GunItem extends GunsModElements.ModElement {
	@ObjectHolder("guns:gun")
	...
	public GunItem(GunsModElements instance) {
		super(instance, 7);
