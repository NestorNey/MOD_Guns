...
public class GlockWeponItem extends GunsModElements.ModElement {
	@ObjectHolder("guns:glock_wepon")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_glock_wepon").setRegistryName("projectile_glock_wepon");

	public GlockWeponItem(GunsModElements instance) {
		super(instance, 2);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GlockWeponRenderer.ModelRegisterHandler());
		FMLJavaModLoadingContext.get().getModEventBus().register(new GlockWeponRenderer.GlockRenderer());
	}
	...
	public static class ItemRanged extends Item implements IAnimatable, ISyncable {
		...
		public void registerControllers(AnimationData data) {
			AnimationController<ItemRanged> controller = new AnimationController<ItemRanged>(this, CONTROLLER, 20, this::predicate);
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Ammo    0 / 15 , ,Maded to kill"));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 2.5, 5);
